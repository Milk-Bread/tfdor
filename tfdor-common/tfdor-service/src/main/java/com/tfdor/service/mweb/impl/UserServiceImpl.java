...
import com.tfdor.core.exception.ValidationRuntimeException;
import com.tfdor.dao.UserDao;
...
public class UserServiceImpl implements UserService {
  ...
  public Map<String, Object> loginCheck(String userId, String password, HttpSession session) throws Exception {
    ...
    if (userMap == null) {
      ...
      if (str == null || !str.startsWith(secretKey.getRandom().toString()) || !passwordaes.equals(userMap.get("password").toString())) {//密码错误
