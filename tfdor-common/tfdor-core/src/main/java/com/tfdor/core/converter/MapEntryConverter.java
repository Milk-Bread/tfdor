package com.tfdor.core.converter;
    ...
    for (Iterator it = set.iterator(); it.hasNext();) {
      ...
      if (keyValue instanceof ArrayList) {
        ...
        if (keyValue instanceof HashMap) {
          ...
          // if(!patternInt.matcher(keyValue.toString()).matches() ||
          // !patternFloat.matcher(keyValue.toString()).matches()) {
